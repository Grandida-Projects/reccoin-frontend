...
const HomeFooter = () => {
  return <div className="container mx-auto w-full font-montserrat bg-primary40 text-white py-16">
        <div className="w-[90%] mx-auto flex flex-col justify-center items-center md:justify-between md:flex-row">
            ...
            <div className="flex flex-row items-center justify-center mt-8 md:mt-0">
                ...
                <div className="flex flex-col">
                    ...
                    <Link
                    to={"/privacy-policy"}
                    className="font-2 mb-4 font-extralight"
                    >
                    Privacy Policy
                    </Link>
                </div>
            ...
            <div className="flex flex-col justify-center items-center mt-8 md:mt-0 md:justify-start md:items-start">
                ...
                <p className="font-2 mb-2 font-extralight">
                1881 SW 164th Avenue
                </p>
                <p className="font-2 mb-4 font-extralight">
                Miramar, FL 33027, USA.
                </p>
                <p className="font-2 font-extralight mb-4">
                info@grandida.com
                </p>
            </div>
