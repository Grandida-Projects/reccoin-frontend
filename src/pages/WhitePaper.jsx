  ...
  return <>
    <div className=" container mx-auto font-montserrat">
      ...
      <div className=" bg-whitePaperHeroBg h-[26rem] flex flex-col justify-center items-center">
          <h1 className="h-[4rem] text-[2.5rem] font-[800] text-white">Recylox Whitepaper</h1>
      ...
      <div className="w-[90%] mx-auto mt-16 leading-[2.8rem]">
        ...
        <p className="text-[1rem] font-[400]">
          This whitepaper outlines the vision, architecture, and technical details of Recylox, a groundbreaking project 
          that aims to transform waste management and recycling by leveraging blockchain technology and 
          incentivizing users with Recylox crypto tokens. By gamifying and rewarding sustainable behavior, Recylox 
        ...
        <ol className="pl-2 mt-8 list-decimal list-inside">
            <li>Introduction: Recylox is a decentralized blockchain-based platform that 
              incentivizes individuals and organizations to participate actively in waste 
              management and recycling initiatives. By issuing Recylox tokens, users are 
              rewarded for adopting sustainable practices, promoting recycling, and 
              minimizing waste generation. Recylox aims to harness the power of blockchain 
            ...
            <li>Problem Statement: The world faces a critical waste management crisis, with 
              ...
              progress towards a sustainable future. Recylox addresses these challenges 
            ...
            <li>Recylox Architecture: 3.1 Blockchain Infrastructure: Recylox operates on a 
              secure, scalable, and decentralized blockchain infrastructure. By leveraging 
              the transparency and immutability of blockchain technology, Recylox ensures 
          ...
          <p className="text-[1rem] font-[400]">
            Recylox utilizes smart contracts to automate the token distribution process 
            ...
            Smart contracts also enable the seamless integration of Recylox with third-party 
            applications, waste management systems, and recycling facilities
          </p>

          <h2 className=" text-center text-[1rem] font-[800] mt-12">Recylox Features:</h2> 
          <h2 className="text-[1rem] font-[800]">User Wallets:</h2> 
          <p className="text-[1rem] font-[400]">Every user participating in the Recylox ecosystem is assigned a digital wallet 
            to securely store their Recylox tokens. This wallet also serves as a transactional 
          ...
          <p className="text-[1rem] font-[400]">Recylox rewards users with Recylox tokens based on their verified 
            recycling activities. By collaborating with waste management entities, recycling 
            facilities, and IoT sensors, Recylox establishes a robust data ecosystem to 
          ...
          <p className="text-[1rem] font-[400]">Recylox features a marketplace where users can redeem their Recylox tokens for 
           ...
           <h1 className="text-[1rem] font-[800] mt-12 text-center">Roadmap and Future Developments:</h1>
            <p className="text-[1rem] font-[400]">Recylox has an ambitious roadmap to expand its network, engage more users, 
              and foster greater environmental impact. Key future developments include integrating 
              Recylox with IoT devices to enhance data collection accuracy, partnering with 
           ...
           <p className="text-[1rem] font-[400]">
              Recylox presents a transformative solution to address the global waste management crisis. 
              By leveraging blockchain technology, Recylox creates a decentralized and transparent 
